...
export function loadSetInformation(slice: Slice) {
  let sc_0 = slice;
  if (sc_0.loadUint(32) !== 2772148550) {
    throw Error("Invalid prefix");
  }
...
export function storeDislike(src: Dislike) {
  return (builder: Builder) => {
    let b_0 = builder;
    b_0.storeUint(2382269825, 32);
  };
}

export function loadDislike(slice: Slice) {
  let sc_0 = slice;
  if (sc_0.loadUint(32) !== 2382269825) {
    throw Error("Invalid prefix");
  }
  return { $$type: "Dislike" as const };
}

function loadTupleDislike(source: TupleReader) {
  return { $$type: "Dislike" as const };
}

function storeTupleDislike(source: Dislike) {
  let builder = new TupleBuilder();
  return builder.build();
}

function dictValueParserDislike(): DictionaryValue<Dislike> {
  return {
    serialize: (src, buidler) => {
      buidler.storeRef(beginCell().store(storeDislike(src)).endCell());
    },
    parse: (src) => {
      return loadDislike(src.loadRef().beginParse());
    },
  };
}
...
async function BusinessCard_init(information: User) {
  const __code = Cell.fromBase64(
    ""
  );
  const __system = Cell.fromBase64(
    ""
  );
  let builder = beginCell();
  builder.storeRef(__system);
  builder.storeUint(0, 1);
  initBusinessCard_init_args({ $$type: "BusinessCard_init_args", information })(
    builder
  );
...
const BusinessCard_types: ABIType[] = [
  ...
  { name: "Dislike", header: 2382269825, fields: [] },
  {
    name: "User",
    header: null,
    fields: [
...
const BusinessCard_receivers: ABIReceiver[] = [
  ...
  { receiver: "internal", message: { kind: "typed", type: "Dislike" } },
...
export class BusinessCard implements Contract {
  ...
  async send(
    ...
    message: SetInformation | Like | Dislike | Deploy
  ) {
    ...
    if (
      ...
      body = beginCell().store(storeDislike(message)).endCell();
    }
    if (
      message &&
      typeof message === "object" &&
